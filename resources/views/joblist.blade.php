                            ...
                            <div class="flex-1">
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm" />
                                </div>
                            </div>
                            <div class="flex-2">
