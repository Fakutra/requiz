    ...
    <div class="max-w-7xl mx-auto px-6 md:px-8">
        <div class="flex justify-between h-[80px] items-center">
            ...
            <div class="hidden sm:flex space-x-6 items-center">
                ...
                <x-nav-link class="text-xl font-medium" href="#job" :active="request()->routeIs('job')">Job</x-nav-link>
            ...
            <div class="hidden sm:flex items-center space-x-4">
                ...
                @else
                    <x-nav-link class="text-xl font-medium" :href="route('login')">Login</x-nav-link>
                    <x-nav-link class="text-xl font-medium" :href="route('register')">Register</x-nav-link>
                @endauth
            </div>
