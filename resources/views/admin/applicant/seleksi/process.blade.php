<x-app-admin>
    ...
    <div class="bg-white shadow-zinc-400/50 rounded-lg p-6">
        ...
        <div class="flex justify-between mb-3">
            <input type="text" class="border rounded px-3 py-2 w-1/4" placeholder="Search..." id="searchInput">
            <div>
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="p-3 border-b">
                                <input type="checkbox" class="applicant-checkbox" name="selected_applicants[]" value="{{ $applicant->id }}">
                            </td>
                            ...
                            <td class="p-3 border-b space-x-2">
                                <div class="flex items-center gap-3">
                                    ...
                                    <form action="{{ route('admin.applicant.destroySeleksi', $applicant->id) }}" method="POST" onsubmit="return confirm('Yakin hapus?')">
                                        @csrf @method('delete')
