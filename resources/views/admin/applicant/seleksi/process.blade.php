                ...
                <form method="GET" action="{{ route('admin.applicant.seleksi.process', ['stage' => $stage]) }}"
                    ...
                    <div>
                        ...
                        <select name="status" class="border rounded px-3 py-2 w-56">
                            ...
                            {{-- Lolos tahap ini = sudah pindah ke tahap berikutnya (nextStage) --}}
                ...
                <div class="overflow-x-auto">
                    <table id="applicantTable" class="w-full text-sm text-left border-collapse">
                        ...
                        <tbody>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="p-3 border-b align-top">
                                        <input type="checkbox" class="applicant-checkbox" name="selected_applicants[]"
                                            value="{{ $applicant->id }}" data-email="{{ $applicant->email }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="p-6 text-center text-gray-500">Tidak ada data untuk
                                        kriteria ini.</td>
                                </tr>
                            @endforelse
                        </tbody>
        ...
        <div x-show="emailModalOpen"
            ...
            <div class="bg-white w-full max-w-2xl rounded-lg shadow-lg p-6" @click.away="closeEmailModal()">
                ...
                <form action="{{ route('admin.applicant.seleksi.sendEmail') }}" method="POST"
                    enctype="multipart/form-data" @submit="validateAndSubmit">
                    @csrf
