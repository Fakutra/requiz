    ...
    <div class="bg-white rounded-lg shadow-sm p-4">
        ...
        <div x-data="applicantPage()" x-init="init()" class="space-y-6">
            ...
            <div class="flex w-full mb-2 items-end gap-2">
                {{-- Search --}}
                <form method="GET" action="{{ route('admin.user.index') }}" class="flex-1 min-w-[220px]">
                ...
                {{-- Tombol Export (boleh tetap ke route lama) --}}
            ...
            {{-- Tabel Applicant (copas dari blade applicant lu) --}}
