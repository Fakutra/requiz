<x-app-admin>
    <div class="bg-white rounded-lg shadow-sm p-4"
        ...
        <div class="flex items-center justify-between mb-4">
            <h1 class="text-2xl font-bold text-blue-950">Master Penempatan</h1>
            <button type="button"
            ...
            <table class="min-w-full text-sm border border-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-3 py-2 border-b text-left">Nama Penempatan</th>
                        <th class="px-3 py-2 border-b text-center w-40">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($placements as $i => $placement)
                        <tr class="hover:bg-gray-50">
                            <td class="px-3 py-2 border-b">{{ $i + 1 }}</td>
                            <td class="px-3 py-2 border-b">{{ $placement->name }}</td>
                            <td class="px-3 py-2 border-b text-center">
                                <div class="inline-flex gap-2">
                                    ...
                                    <form action="{{ route('admin.placements.destroy', $placement) }}" method="POST"
        ...
        <div x-show="showCreate"
            ...
            <div @click.away="showCreate = false"
                ...
                <form action="{{ route('admin.placements.store') }}" method="POST" class="space-y-4">
                    @csrf
