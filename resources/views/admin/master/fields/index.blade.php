<x-app-admin>
    <div class="bg-white rounded-lg shadow-sm p-4"
         x-data="{
            ...
            editId: null,
            editName: '',
            baseEditUrl: '{{ url('admin/fields') }}'
         }"
         x-cloak>

        <div class="flex items-center justify-between mb-4">
            <h1 class="text-2xl font-bold text-blue-950">Master Bidang</h1>
            <button type="button"
            ...
            <table class="min-w-full text-sm border border-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-3 py-2 border-b text-left">Nama Bidang</th>
                ...
                <tbody>
                    @forelse ($fields as $i => $field)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-3 py-2 border-b">{{ $field->name }}</td>
